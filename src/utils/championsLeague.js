const { noReseedSpreads, noReseedTotals, bestBet, getInitialSeedAmount, leagues, properOrders } = require("./seederUtils")
...
function ChampionsLeagueAuto(game, gameID, id, league, username) {
    ...
    const {SpreadsAlreadyBet, homeMain, awayMain} = noReseedSpreads(homeSpreads, awaySpreads, id, mainHomeSpread, mainAwaySpread)
    const {TotalsAlreadyBet, overMain, underMain} = noReseedTotals(overs, unders, id, mainTotal)
